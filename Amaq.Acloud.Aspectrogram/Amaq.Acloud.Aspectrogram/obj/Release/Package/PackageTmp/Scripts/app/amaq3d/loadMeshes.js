...
LoadMeshes = (function () {
    ...
    LoadMeshes = function (idEntity, canvasType, parentContId, wId) {
        ...
        _loadCanvasText = function (idPoint) {
            ...
            dt.drawText(vbles[idPoint].Name, null, 20, "bold 12px  Calibri", "#999999", null);
            dt.drawText("", null, 45, "bold 13px  Calibri", "#999999", null);
            dt.drawText("", null, 65, "bold 13px  Calibri", "#999999", null);
        ...
        this.locateCamera = function () {
            ...
            _scene.activeCamera.radius = radius * 2;
            ...
            _scene.activeCamera.wheelPrecision = 1000 / radius;
