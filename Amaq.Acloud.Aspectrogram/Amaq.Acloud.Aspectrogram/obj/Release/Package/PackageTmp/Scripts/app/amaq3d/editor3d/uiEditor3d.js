...
var UiEditor3d = (function ()
{
    ...
    UiEditor3d = function (idEntity, functions, treeEd3d, flagProp3d, entityType) {
        ...
        _createGroupAxisConfig = function () {
            ...
            _groupsTier2.axisConfig.append('<div class="nameInputTransEd3d"> Largo: <input type="number" id="' + _gral + _Tier2.gral + _Tier2.axisConfig.longAxis + '" style="margin: 4px; height: 15px; width: 45px; display: inline; position: relative; left: 5px;" class="inputTxted3dMainMenu"></div>');
