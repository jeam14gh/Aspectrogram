...
intellisense.annotate(jQuery.fn, {
    ...
    'ejWaitingPopup': function () {
        ///<signature>
        ///<summary> The WaitingPopup control for JavaScript is a visual element that provides support for displaying a pop-up indicator over a target area and preventing the end userâ€™s interaction with the target area while loading. </summary>
        ///</signature>
    }
});